# Face-Detection
This project is a high-performance face detection application built with Python. It utilizes a pre-trained Deep Neural Network (DNN) model to detect human faces in various souces: images, videos, live webcam
